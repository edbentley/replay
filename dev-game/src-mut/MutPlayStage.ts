...
import { testContext, TestContextChild, TestContext } from "./MutTestContext";
          ...
          MutClickable.Single({
            ...
            spritesPressed: [
              ...
              t2.text(
                ...
                (thisProps) => {
                  thisProps.text = state.paused ? "Resume" : "Pause";
                }
              ),
            ],
            onPress: function clickableOnPress() {
              if (state.paused) {
                timer.resume(state.spawnEnemyTimerId);
              } else {
                timer.pause(state.spawnEnemyTimerId);
              }
